...
- **BLE**: Advertisement-based. Listens for Manufacturer Specific Data containing a 4-byte monotonic counter, 1-byte command (0x01=unlock, 0x02=lock), and 4-byte AES-CCM Message Integrity Code (MIC).
